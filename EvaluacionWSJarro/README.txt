...
a persistence unit "EvaluacionWSJarroPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSJarro\pom.xml":
...
artifact ("EvaluacionWSJarro.war") is already built. You can build
